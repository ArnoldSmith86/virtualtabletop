...
test('Create game using edit mode', async t => {
  ...
  await t
    ...
    .click('#add-deck_K_S')
    .click('[id="3nsjB"]')
    .click('[id="3nsjP"] > .widget-content > .handle')
    .click('#pileOverlay > button:nth-of-type(3)')
    .click('[id="b86p"] > .widget-content > .handle')
    .click('#pileOverlay > button:nth-of-type(1)')
    .click('[id="b86p"] > .widget-content > .handle')
    .click('#pileOverlay > button:nth-of-type(3)')
    .click('[id="5ip4"] > .widget-content > .handle')
    .click('#pileOverlay > button:nth-of-type(2)')
    .dragToElement('[id="5ip4"] > .widget-content > .handle', '[id="hand"]')
    .click('#editButton')
    .click('#jyo2')
