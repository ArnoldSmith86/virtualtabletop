...
describe('operation rendering', () => {
  ...
  test.each([
    ...
    [ { func: 'MOVE', from: 'deck1', to: 'hand1', position: 'pileBottom' }, 'Move 1 widget from deck1 to hand1 and place them at the bottom of the pile' ],
    [ { func: 'MOVE', from: 'deck1', to: 'hand1', position: 'groupEnd' }, 'Move 1 widget from deck1 to hand1 and place them in a new spread group after the others' ],
    ...
    [ { func: 'SORT', holder: 'hand1', key: [ 'suit', 'rank' ], groupBy: 'suit' }, 'Sort hand1 by suit and rank and group them by suit' ],
