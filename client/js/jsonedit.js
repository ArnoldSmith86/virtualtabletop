...
function jeAddCommands() {
  ...
  jeAddRoutineOperationCommands('ZOOM', { level: 1, panX: 0, panY: 0, player: null, prompt: "This game wants to override your locked zoom settings and change the view. Do you agree?" });
