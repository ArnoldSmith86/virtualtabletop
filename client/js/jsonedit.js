...
const jeCommands = [
  ...
  },
  {
    ...
    context: '^.* ↦ icon( ↦ [0-9]+| ↦ "|$)',
    call: async function() {
      const newValue = { name: '###SELECT ME###', scale: 1, offsetX: 0, offsetY: 0, rotation: 0, opacity: null, color: '', strokeColor: '', strokeWidth: 0, hoverColor: '', hoverStrokeColor: '', hoverStrokeWidth: null, hoverOpacity: null };
