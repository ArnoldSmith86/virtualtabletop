...
const jeCommands = [
  ...
  },
  {
    ...
    context: '^.*\\((CANVAS|CLICK|COUNT|DELETE|FLIP|FOREACH|GET|LABEL|MOVE|ROTATE|SET|SHUFFLE|SORT|TIMER)\\) ↦ collection|^.*\\((CLONE|SELECT|TURN)\\) ↦ source|^.*\\(RECALL\\) ↦ excludeCollection',
    show: function() {
...
function jeCanInsertOperation() {
  ...
  if(!command || !jeStateNow || jeJSONerror)
    return false;
