...
const routineComputeOperations = {
  ...
  'replaceAll': { word: 'with every', template: '{x} {operator} {y} replaced by {z}', group: 'Text', note: "In the replacement, $& stands for the text that was found, $` for everything before it, $' for everything after it and $$ for a single dollar sign." },
  'replace': { word: 'with the first', template: '{x} {operator} {y} replaced by {z}', group: 'Text', note: "In the replacement, $& stands for the text that was found, $` for everything before it, $' for everything after it and $$ for a single dollar sign." },
