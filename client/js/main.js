...
function findAudioSources(widget) {
  let audioSources = new Set(); // Prevents multiple audio sources for same widget
  // Check for any routines with AUDIO function
...
function getAudioArray() {
  let audioSet = new Set(); // prevents multiple audio source from different widgets
