...
// the shared context of both kinds of report: a crash report adds the error on top, a feedback
// report sends this as-is (or only the userAgent when the player opted out of the room snapshot)
