            ...
            for(const [faceIndex, face] of v.entries()) {
                ...
                if(Array.isArray(face.objects)) {
                    for(const [objIndex, obj] of face.objects.entries()) {
                        ...
                        const validObjProps = ['type', 'x', 'y', 'width', 'height', 'fontSize', 'textAlign', 'rotation', 'display', 'classes', 'css', 'dynamicProperties', 'svgReplaces', 'value', 'color', 'note', 'size', 'src', 'html'];
